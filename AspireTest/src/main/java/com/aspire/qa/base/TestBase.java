...
public class TestBase {
	...
	public TestBase() {
		try {
			prop = new Properties();
			FileInputStream ip = new FileInputStream(System.getProperty("user.dir")+ "/src/main/java/com/aspire"
	...
	public static void initialization(){
		...
		if(browserName.equals("chrome")){
			...
			System.setProperty("webdriver.gecko.driver", "D:\\geckodriver_win32\\geckodriver.exe");	
